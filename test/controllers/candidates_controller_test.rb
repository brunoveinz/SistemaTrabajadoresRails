...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference("Candidate.count") do
      post candidates_url, params: { candidate: { age: @candidate.age, name: @candidate.name, position: @candidate.position } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { age: @candidate.age, name: @candidate.name, position: @candidate.position } }
